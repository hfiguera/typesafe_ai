defmodule TypeSafe.Bench.Load do
  ...
  def measure(opts) do
    ...
    if scenario.profile == "defaults" and
         scenario.client not in ~w(typesafe jev typesafe_api typesafe_sdk),
       do: raise(ArgumentError, "defaults profile supports only the four community SDKs")
